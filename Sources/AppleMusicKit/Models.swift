...
public struct SearchResults: Codable {
    ...
    public init(
        songs: SongResults? = nil,
        artists: ArtistResults? = nil,
        albums: AlbumResults? = nil,
...
public struct Artist: Codable, Identifiable {
    ...
    public init(
        ...
        type: String,
        href: String,
        attributes: ArtistAttributes? = nil,
...
public struct Album: Codable, Identifiable {
    ...
    public init(
        ...
        type: String,
        href: String,
        attributes: AlbumAttributes? = nil,
...
public struct Artwork: Codable {
    ...
    public func getURL(width: Int, height: Int) -> String {
        url.replacingOccurrences(of: "{w}", with: "\(width)")
